...
export default function CartNotification() {
  ...
  return (
    <div className="fixed left-0 bottom-0 lg:absolute lg:right-12 lg:top-full lg:left-auto lg:bottom-auto bg-white w-full lg:w-[25rem] h-[17rem] rounded-t-3xl lg:rounded-b-3xl lg:rounded-t-none z-20 p-5 text-[0.95rem]">
