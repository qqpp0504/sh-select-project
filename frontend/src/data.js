...
export const NAVITEMS = [
  ...
  },
  {
    ...
    items: {
      精選: [
        { item: "新品發售", link: "/products?gender=men&newProduct=new" },
        { item: "選購所有特惠商品", link: "/products?gender=men&onSale=sale" },
      ],
      服飾與鞋款: [
        { item: "上衣", link: "/products?gender=men&category=top" },
        { item: "外套及背心", link: "/products?gender=men&category=jacket" },
        { item: "下著", link: "/products?gender=men&category=bottom" },
        { item: "襪子", link: "/products?gender=men&category=socks" },
        { item: "鞋款", link: "/products?gender=men&category=shoes" },
        { item: "其他配件", link: "/products?gender=men&category=other" },
      ],
      依品牌選購: [
        { item: "Adidas", link: "/products?gender=men&brands=adidas" },
        { item: "Asics", link: "/products?gender=men&brands=asics" },
        { item: "Carhartt", link: "/products?gender=men&brands=carhartt" },
        { item: "Converse", link: "/products?gender=men&brands=converse" },
        { item: "Mizuno", link: "/products?gender=men&brands=mizuno" },
        { item: "Nautica", link: "/products?gender=men&brands=nautica" },
        { item: "Nike", link: "/products?gender=men&brands=nike" },
        { item: "Ordinary", link: "/products?gender=men&brands=ordinary" },
        {
          item: "The North Face",
          link: "/products?gender=men&brands=theNorthFace",
        },
      ],
    },
    link: "men",
  },
  {
    ...
    items: {
      精選: [
        { item: "新品發售", link: "/products?gender=women&newProduct=new" },
        {
          item: "選購所有特惠商品",
          link: "/products?gender=women&onSale=sale",
        },
      ],
      服飾與鞋款: [
        { item: "上衣", link: "/products?gender=women&category=top" },
        { item: "外套及背心", link: "/products?gender=women&category=jacket" },
        { item: "下著", link: "/products?gender=women&category=bottom" },
        { item: "運動內衣", link: "/products?gender=women&category=sportsbar" },
        { item: "襪子", link: "/products?gender=women&category=socks" },
        { item: "鞋款", link: "/products?gender=women&category=shoes" },
        { item: "其他配件", link: "/products?gender=women&category=other" },
      ],
      依品牌選購: [
        { item: "Adidas", link: "/products?gender=women&brands=adidas" },
        { item: "Asics", link: "/products?gender=women&brands=asics" },
        { item: "Carhartt", link: "/products?gender=women&brands=carhartt" },
        { item: "Converse", link: "/products?gender=women&brands=converse" },
        { item: "Mizuno", link: "/products?gender=women&brands=mizuno" },
        { item: "Nautica", link: "/products?gender=women&brands=nautica" },
        { item: "Nike", link: "/products?gender=women&brands=nike" },
        { item: "Ordinary", link: "/products?gender=women&brands=ordinary" },
        {
          item: "The North Face",
          link: "/products?gender=women&brands=theNorthFace",
        },
      ],
    },
    link: "female",
